...
function Toast({ message, onDone }: { message: string; onDone: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 bg-stone-900 text-white px-4 py-3 rounded-xl shadow-xl text-sm font-medium animate-slide-up">
  ...
  return (
    <div className="max-w-2xl space-y-6 pb-12">
      ...
      <div className="animate-fade-in">
        ...
        <p className="text-stone-500 mt-1">Jouw culinaire identiteit en stijl-DNA.</p>
      </div>
      ...
      <div className="card p-6 flex items-center gap-5 animate-slide-up opacity-0" style={{ animationDelay: '50ms', animationFillMode: 'forwards' }}>
        ...
        <div className="flex-1 min-w-0">
          ...
          {profile.kitchen_type && (
            <p className="text-xs text-stone-400 capitalize mt-0.5">{profile.kitchen_type}</p>
          )}
        </div>
      ...
      <div className="card p-6 space-y-5 animate-slide-up opacity-0" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-stone-400 mt-0.5">AI-analyse op basis van jouw activiteit</p>
          </div>
          <button
            type="button"
