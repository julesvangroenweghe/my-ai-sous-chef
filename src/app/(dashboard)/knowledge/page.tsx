        ...
        <div className="flex items-center justify-between pt-4 border-t border-[#E8D5B5]">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={page === 0}
              className="p-2 rounded-lg bg-white text-[#9E7E60] disabled:opacity-30 hover:bg-[#FDF8F2]"
            >
              <ChevronLeft size={16} />
            </button>
            <button
      ...
      {data.map((r: any) => (
        <div key={r.id} className="p-4 bg-white/50 border border-[#E8D5B5]/50 rounded-lg">
          ...
          <div className="flex gap-2 mt-2">
            ...
            {r.source && <span className="text-xs px-2 py-0.5 rounded bg-[#FDF8F2]/50 text-[#9E7E60]">{r.source}</span>}
          </div>
        </div>
      ))}
    </div>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-[#E8D5B5] text-left text-[#9E7E60]">
