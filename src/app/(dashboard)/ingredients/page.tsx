...
import { Plus, Search, Apple, Leaf, ArrowUpDown, Star, Award, Filter, ChevronLeft, ChevronRight } from 'lucide-react'
   ...
   <div className="space-y-8">
     ...
     <div className="flex items-center justify-between py-4">
       <div className="text-xs text-stone-400">
         {filtered.length > 0
           ? `${(page - 1) * PAGE_SIZE + 1}–${Math.min(page * PAGE_SIZE, filtered.length)} van ${filtered.length} ingrediënten`
           : `0 van ${ingredients.length} ingrediënten`}
       </div>
       <div className="flex items-center gap-2">
         <button
