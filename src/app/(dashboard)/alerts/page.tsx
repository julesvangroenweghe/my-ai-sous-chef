  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: 800 }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 24, borderBottom: '1px solid #E8D5B5', paddingBottom: 12 }}>
        {([['all', 'Alle'], ['price_update', 'Prijswijzigingen'], ['out_of_stock', 'Niet voorradig'], ['deal', 'Aanbiedingen']] as [string, string][]).map(([key, label]) => (
      ...
      {loading && <div style={{ textAlign: 'center', padding: 60, color: '#9E7E60' }}>Laden...</div>}
